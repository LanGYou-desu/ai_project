...
(function (global) {
  ...
  add({
    ...
    snippet: '实验室的留言板。SIGMA-7 留过言："五年了。你还在听吗？"',
  ...
  add({
    ...
    <table class="retro" width="100%" cellpadding="4">
      ...
      <tr><td><b>4F SIGMA-7</b>：十五年整了。他还在听，只是没人懂。</td></tr>
  ...
  add({
    ...
    <div class="feed">
      ...
      2010-12-31 23:59 —— 第四枚密钥：声。十五年整，信号还在。如果你在看，那么接下来，去 2025 年的档案馆吧。</div>
    </div>
    <a href="http://weiyu.cn/">[返回微语]</a>`
  });
  ...
  add({
    ...
    <p>还有一个名字，反复出现在他的世界里：<b>SIGMA-7</b>——他 1993 年收到的第一位听众来信的署名。1995 年，SIGMA-7 在告别帖下留言「十年后见」，之后再也没有人见过他。</p>
    <p>有人说，顾言不是在逃跑，而是在等一个人回来。</p>
  ...
  add({
    ...
    <h4 class="why-title">—— 为什么广播三十年 ——</h4>
    <blockquote class="epilogue why">
      「你可能想问：三十年，对着没有人听的电波，图什么？<br>
      1995 年的最后一期节目里，我说过一句话：互联网会把一切都记住。<br>
      当时有人笑我——声音是世界上最留不住的东西，播完就没了。<br>
      可我不信。我把每一个字节都留在硬盘里，把广播一直开着。<br>
      不是为了给谁听，是为了证明：被发射出去的声音，永远不会消失，它只是在等。<br>
      等一个像你这样的人，顺着旧链接、旧密文和源代码里的注释，一路找到这里。<br>
      互联网没有忘记我。我也没有忘记互联网。<br>
      至于 SIGMA-7——1993 年，他是我的第一位听众。他说过，电台不会消失，只要还有人听。<br>
      1995 年，他留言「十年后见」，然后搬去了很远的地方。<br>
      我广播了三十年，有一半，是怕他回来的时候，找不到我。」
    </blockquote>
